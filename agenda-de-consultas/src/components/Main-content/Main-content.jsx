...
import ContainerAppointments from "../Container-appointments/Container-appointments";
  ...
  return (
    <main className="main-content">
      <section className="main-content__section-scheduled-appointments">
        ...
        <ContainerAppointments title="Quarta-feira" mClass="container--margin-top container--padding-bottom">
          <Card
            name="Clara Lemos"
            modality="Consulta no local"
            hour="18:00 - 19:00 &#40;1 hora&#41;"
